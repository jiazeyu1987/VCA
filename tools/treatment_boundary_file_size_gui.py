...
from treatment_boundary_file_size import BoundaryDetectionError, analyze_folder


METHOD_TITLE = "PNG File Size"
ANALYZE_MODULE_NAME = "treatment_boundary_file_size"
