...
from treatment_boundary_peak_state import BoundaryDetectionError, analyze_folder


METHOD_TITLE = "Peak State Machine"
ANALYZE_MODULE_NAME = "treatment_boundary_peak_state"
