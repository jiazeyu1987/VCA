...
from treatment_boundary_bright_ratio import BoundaryDetectionError, analyze_folder


METHOD_TITLE = "Bright Pixel Ratio"
ANALYZE_MODULE_NAME = "treatment_boundary_bright_ratio"
